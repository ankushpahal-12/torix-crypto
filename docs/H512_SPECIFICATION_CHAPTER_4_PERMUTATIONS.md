...
$$
\pi_{\text{shift}}(r, c) = (r, \; (c + r) \bmod 8)
$$

In terms of linear coordinate index $i = 8r + c$:

$$
\pi_{\text{shift}}(8r + c) = 8r + ((c + r) \bmod 8)
$$
...
$$
\pi_{\text{quad}}(r, c) = ((r + 4) \bmod 8, \; (c + 4) \bmod 8)
$$

In terms of linear coordinate index $i = 8r + c$:

$$
\pi_{\text{quad}}(8r + c) = 8 \cdot ((r + 4) \bmod 8) + ((c + 4) \bmod 8)
$$
...
$$
\Phi_m = ( (\alpha, \beta, \gamma, \delta)_m, \; \text{SwapQuads}_m, \; \pi_{\text{global}, m} ), \quad m = i \bmod 4
$$
